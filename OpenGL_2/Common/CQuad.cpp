...
CQuad::CQuad()
{
	m_Points[0] = vec4( -5.0f,  -5.0f, 0.0f, 1.0f);
	m_Points[1] = vec4(  0.0f,  5.0f, 0.0f, 1.0f);
	m_Points[2] = vec4(  0.0f, -2.0f, 0.0f, 1.0f);
	m_Points[3] = vec4( 0.0f, 5.0f, 0.0f, 1.0f);
	m_Points[4] = vec4( 5.0f, -5.0f, 0.0f, 1.0f);
	m_Points[5] = vec4( 0.0f, -2.0f, 0.0f, 1.0f);
	...
	m_Colors[5] = vec4( 0.0f, 1.0f,  0.0f, 1.0f);
